...
namespace PayBar.TerminalService {
    ...
    public interface ITerminalService {
        ...
        PayBar.TerminalService.TxnResult PayBill(string User, string Pass, int TermID, int posCondition, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/PayBill", ReplyAction="http://tempuri.org/ITerminalService/PayBillResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> PayBillAsync(string User, string Pass, int TermID, int posCondition, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate);
        ...
        PayBar.TerminalService.TxnResult InstallmentBill(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/InstallmentBill", ReplyAction="http://tempuri.org/ITerminalService/InstallmentBillResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> InstallmentBillAsync(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate);
        ...
        PayBar.TerminalService.TxnResult UDBill(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/UDBill", ReplyAction="http://tempuri.org/ITerminalService/UDBillResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> UDBillAsync(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate);
        ...
        PayBar.TerminalService.TxnResult BuyCharge(string User, string Pass, int TermID, int posCondition, string Company, long PriceID, long ResNum, string Pan, string Pin, string CVV, string ExpDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/BuyCharge", ReplyAction="http://tempuri.org/ITerminalService/BuyChargeResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> BuyChargeAsync(string User, string Pass, int TermID, int posCondition, string Company, long PriceID, long ResNum, string Pan, string Pin, string CVV, string ExpDate);
        ...
        PayBar.TerminalService.TxnResult Topup(string User, string Pass, int TermID, int posCondition, string Company, string ChargeType, string CellNo, long Amount, long ResNum, string Pan, string Pin, string CVV, string ExpDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/Topup", ReplyAction="http://tempuri.org/ITerminalService/TopupResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> TopupAsync(string User, string Pass, int TermID, int posCondition, string Company, string ChargeType, string CellNo, long Amount, long ResNum, string Pan, string Pin, string CVV, string ExpDate);
        ...
        PayBar.TerminalService.TxnResult Purchase(string User, string Pass, int TermID, int posCondition, long Amount, string ResNum, string Pan, string Pin, string CVV, string ExpDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/Purchase", ReplyAction="http://tempuri.org/ITerminalService/PurchaseResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> PurchaseAsync(string User, string Pass, int TermID, int posCondition, long Amount, string ResNum, string Pan, string Pin, string CVV, string ExpDate);
        ...
        PayBar.TerminalService.TxnResult GetBillStatus(string User, string Pass, string BillID, string PayID, int TermID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITerminalService/GetBillStatus", ReplyAction="http://tempuri.org/ITerminalService/GetBillStatusResponse")]
        System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> GetBillStatusAsync(string User, string Pass, string BillID, string PayID, int TermID);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITerminalServiceChannel : PayBar.TerminalService.ITerminalService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TerminalServiceClient : System.ServiceModel.ClientBase<PayBar.TerminalService.ITerminalService>, PayBar.TerminalService.ITerminalService {
        ...
        public PayBar.TerminalService.TxnResult PayBill(string User, string Pass, int TermID, int posCondition, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.PayBill(User, Pass, TermID, posCondition, BillID, PayID, Pan, Pin, CVV, ExpDate);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> PayBillAsync(string User, string Pass, int TermID, int posCondition, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.PayBillAsync(User, Pass, TermID, posCondition, BillID, PayID, Pan, Pin, CVV, ExpDate);
        }
        
        public PayBar.TerminalService.TxnResult InstallmentBill(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.InstallmentBill(User, Pass, TermID, BillID, PayID, Pan, Pin, CVV, ExpDate);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> InstallmentBillAsync(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.InstallmentBillAsync(User, Pass, TermID, BillID, PayID, Pan, Pin, CVV, ExpDate);
        }
        
        public PayBar.TerminalService.TxnResult UDBill(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.UDBill(User, Pass, TermID, BillID, PayID, Pan, Pin, CVV, ExpDate);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> UDBillAsync(string User, string Pass, int TermID, string BillID, string PayID, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.UDBillAsync(User, Pass, TermID, BillID, PayID, Pan, Pin, CVV, ExpDate);
        }
        
        public PayBar.TerminalService.TxnResult BuyCharge(string User, string Pass, int TermID, int posCondition, string Company, long PriceID, long ResNum, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.BuyCharge(User, Pass, TermID, posCondition, Company, PriceID, ResNum, Pan, Pin, CVV, ExpDate);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> BuyChargeAsync(string User, string Pass, int TermID, int posCondition, string Company, long PriceID, long ResNum, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.BuyChargeAsync(User, Pass, TermID, posCondition, Company, PriceID, ResNum, Pan, Pin, CVV, ExpDate);
        }
        
        public PayBar.TerminalService.TxnResult Topup(string User, string Pass, int TermID, int posCondition, string Company, string ChargeType, string CellNo, long Amount, long ResNum, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.Topup(User, Pass, TermID, posCondition, Company, ChargeType, CellNo, Amount, ResNum, Pan, Pin, CVV, ExpDate);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> TopupAsync(string User, string Pass, int TermID, int posCondition, string Company, string ChargeType, string CellNo, long Amount, long ResNum, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.TopupAsync(User, Pass, TermID, posCondition, Company, ChargeType, CellNo, Amount, ResNum, Pan, Pin, CVV, ExpDate);
        }
        
        public PayBar.TerminalService.TxnResult Purchase(string User, string Pass, int TermID, int posCondition, long Amount, string ResNum, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.Purchase(User, Pass, TermID, posCondition, Amount, ResNum, Pan, Pin, CVV, ExpDate);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> PurchaseAsync(string User, string Pass, int TermID, int posCondition, long Amount, string ResNum, string Pan, string Pin, string CVV, string ExpDate) {
            return base.Channel.PurchaseAsync(User, Pass, TermID, posCondition, Amount, ResNum, Pan, Pin, CVV, ExpDate);
        }
        
        public PayBar.TerminalService.TxnResult GetBillStatus(string User, string Pass, string BillID, string PayID, int TermID) {
            return base.Channel.GetBillStatus(User, Pass, BillID, PayID, TermID);
        }
        
        public System.Threading.Tasks.Task<PayBar.TerminalService.TxnResult> GetBillStatusAsync(string User, string Pass, string BillID, string PayID, int TermID) {
