...
namespace Data.Models.Generated.PayBar
{
    ...
    public partial class Document : PayBarDB.Record<Document>  
    {
		[Column] public long ID { get; set; }
		[Column] public string Title { get; set; }
		[Column] public int DocumentType { get; set; }
		[Column] public DateTime CreatedOn { get; set; }
		[Column] public string CreatedBy { get; set; }
	...
	[PrimaryKey("ID")]
	[ExplicitColumns]
    public partial class Player : PayBarDB.Record<Player>  
    {
		[Column] public long ID { get; set; }
		[Column] public string PlayerID { get; set; }
	...
	[TableName("dbo.SwResponseCodes")]
	[ExplicitColumns]
    public partial class SwResponseCode : PayBarDB.Record<SwResponseCode>  
    {
		[Column] public int RspCode { get; set; }
		[Column] public string RspTitle { get; set; }
		[Column] public string RespPersianTitle { get; set; }
	}
    ...
    public partial class Txn : PayBarDB.Record<Txn>  
    {
		...
		[Column] public int MaxTry { get; set; }
		[Column] public int TryCount { get; set; }
		[Column] public DateTime? NextRunTime { get; set; }
	}
